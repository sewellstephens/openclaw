...
- **Localhost**: open `http://0.0.0.0:18789/`.
...
- Ensure the gateway is reachable (local: `openclaw status`; remote: SSH tunnel `ssh -N -L 18789:0.0.0.0:18789 user@host` then open `http://0.0.0.0:18789/`).
